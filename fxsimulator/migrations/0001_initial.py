# Generated by Django 5.0.9 on 2024-11-18 17:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.CharField(choices=[('Pending', 'Pending'), ('Profit', 'Profit'), ('Loss', 'Loss')], default='Pending', max_length=7)),
                ('amount_diff', models.FloatField(default=None, null=True)),
                ...
                ('closing_period', models.PositiveBigIntegerField(default=None, null=True)),
